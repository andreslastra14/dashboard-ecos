  ...
  return (
    <ResponsiveContainer width="100%" height={200}>
      <LineChart data={data} margin={{ top: 5, right: 10, left: -10, bottom: 5 }}>
        ...
        <Line type="monotone" dataKey="youtube" stroke="#1e3a5f" strokeWidth={2} dot={false} name="YouTube" />
        <Line type="monotone" dataKey="mined" stroke="#2e6da4" strokeWidth={2} dot={false} name="MINED" />
