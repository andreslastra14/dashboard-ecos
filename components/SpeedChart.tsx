  ...
  return (
    <ResponsiveContainer width="100%" height={200}>
      <AreaChart data={data} margin={{ top: 5, right: 10, left: -10, bottom: 5 }}>
        ...
        <Area type="basis" dataKey="descarga" stroke="#1e3a5f" fill={`url(#${gradDesc})`} strokeWidth={2} name="Ethernet" />
        <Area type="basis" dataKey="subida" stroke="#2e6da4" fill={`url(#${gradSub})`} strokeWidth={2} name="WiFi" strokeDasharray="4 2" />
      </AreaChart>
    </ResponsiveContainer>
  );
}
